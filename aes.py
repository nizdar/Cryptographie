# -*- coding: utf-8 -*-
"""
Created on Wed Apr 15 10:26:56 2020
...
s_box=[[0x63,0x7c,0x77,0x7b,0xf2,0x6b,0x6f,0xc5,0x30,0x01,0x67,0x2b,0xfe,0xd7,0xab,0x76],
         ...
         [0xcd,0x0c,0x13,0xec,0x5f,0x97,0x44,0x17,0xc4,0xa7,0x7e,0x3d,0x64,0xd5,0x19,0x73],
...
#--
def subBytes(boxes):
    boxes_trans=np.zeros((4,4), type(int))
    for i in range(4): 
        for j in range(4):
...
def keyExpansion(key):
    c=np.concatenate((toBoxes(key),np.zeros((4,4*10), int)), axis=1)
    for j in range(4,44):
        if j%4==0:
            column_multiple(c, j)
        else:
